...
```
curl "https://www.nubesgen.com/demo.tgz?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.free&runtime=DOCKER&database=NONE.free&addons=key_vault,storage_blob&gitops=true" | tar -xzvf -
```
